...
| `api/_lib/verse-dex.js` | Allowlisted mainnet liquidity routing: Verse DEX is primary for Ethereum VERSE/USDC; QuickSwap is the Polygon liquidity fallback for fxVERSE/USDC. Both use exact approvals, minimum output, reserve/impact limits, and wallet-signed execution. |
